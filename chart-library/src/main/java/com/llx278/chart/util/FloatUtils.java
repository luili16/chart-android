...
public class FloatUtils {
    ...
    public static void computeAutoGeneratedAxisValues(float start, float stop, int steps, AxisAutoValues outValues) {
        ...
        //Log.d("FloatUtils","start = " + start + " stop = " + stop + " steps = " + steps + " rawIntervals = " +rawInterval+ " intervals = " + interval + "\nfirst = " + first + "\nlast = " + last + "\nvalues[] = " + Arrays.toString(outValues.values) + "\nvaluesNumber = " + valuesNum + "\ndecimal = " + outValues.decimals);
    }
}
