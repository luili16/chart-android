...
public abstract class ChartUtils {
    ...
    public static final int DEFAULT_GRID_COLOR = Color.parseColor("#C0C0C0");
    public static final int DEFAULT_AXIS_COLOR = Color.parseColor("#929292");
    public static final int DEFAULT_LABEL_COLOR = Color.parseColor("#000000");
